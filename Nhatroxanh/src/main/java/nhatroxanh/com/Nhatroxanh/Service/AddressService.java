...
public class AddressService {
    ...
    public Address processAddressFromApi(String provinceCode, String districtCode, String wardCode,
        ...
        Province province = getOrCreateProvince(provinceCode, provinceName);
        District district = getOrCreateDistrict(districtCode, districtName, province);
        Ward ward = getOrCreateWard(wardCode, wardName, district);
        return createAddress(street, ward);
    }
}