...
public interface EmailService {
    ...
    // New methods for transaction emails
    void sendTransactionApprovedEmail(String to, String fullname, String transactionReference, String transactionType, Double amount, String processedAt, String approvalNote);

    void sendTransactionRejectedEmail(String to, String fullname, String transactionReference, String transactionType, Double amount, String processedAt, String rejectionReason);
}