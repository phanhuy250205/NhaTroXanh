...
public interface PaymentService {
     ...
     */
    Page<PaymentResponseDto> getPaymentsByOwnerIdAndStatusWithPagination(Integer ownerId, PaymentStatus status,
            Pageable pageable);
     ...
     */
    Map<String, Object> calculateUtilityCosts(Integer previousReading, Integer currentReading, String utilityType,
            Float unitPrice);
     ...
     * 
     * @param payments List of PaymentResponseDto containing unpaid or overdue
     *                 invoices
    ...
    Payments findPaymentById(Integer paymentId);
}